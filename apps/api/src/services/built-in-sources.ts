...
const eurostatOpenDataDescription =
  'Дані Eurostat про студентів ІТ-напрямів у країнах Європи за статтю, країною та роком. Показано повні узгоджені спостереження. Окремих закладів освіти немає; «Інші» — залишок загальної кількості поза жіночою та чоловічою категоріями.';
