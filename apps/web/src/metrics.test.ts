...
describe('dashboard metrics', () => {
  it('calculates totals from API rows', () => expect(calculateTotals([{ year: 2025, region: 'Kyiv', institution: 'Demo', women: '12', men: '20', nonbinary: '1', total: '33' }])).toEqual({ w: 12, m: 20, n: 1 }));
